/*
  ...
  - You are about to drop the column `bankSerialNo` on the `BankTransaction` table. All the data in the column will be lost.
...
INSERT INTO "new_BankTransaction" ("accountingId", "amount", "createdAt", "date", "description", "id", "type") SELECT "accountingId", "amount", "createdAt", "date", "description", "id", "type" FROM "BankTransaction";
